...
<head>
    ...
    <style>
        ...
        .sidebar a:hover, .sidebar a.active { color: #fff; background-color: #343a40; border-radius: 5px; }
        ...
        [data-bs-theme="dark"] .table-light { background-color: #2c2c2c; color: #fff; }
        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 p-3 sidebar text-white">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2">
                        <a href="{{ route('admin.keys.index') }}" class="{{ request()->routeIs('admin.keys.*') ? 'active' : '' }}">
            ...
            <div class="col-md-9 col-lg-10 p-0">
                <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm px-4 d-flex justify-content-between">
                    <span class="navbar-text fw-bold">Xin chào, Quản trị viên!</span>
                    <button id="themeToggle" class="btn btn-outline-secondary btn-sm rounded-circle" style="width: 35px; height: 35px;">
