...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <div class="card border-0 shadow-sm h-100 rounded-3">
                    <div class="card-body">
                        ...
                        <div class="mt-3 fs-6">
                            <span class="text-success fw-bold small"><i class="fas fa-check-circle"></i>
                                {{ $orders24hSuccess }} Thành công</span>
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <div
                    class="card border-0 shadow-sm h-100 {{ $apiErrors > 0 ? 'bg-danger' : 'bg-success' }} text-white rounded-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                        ...
                        @if($apiErrors > 0)
                            <div class="mt-2 border-top border-light pt-2">
                                <a href="{{ route('admin.orders.index', ['filter_api_error' => 1]) }}"
                                    class="text-white text-decoration-none small fw-bold">
                                    Xem chi tiết đơn lỗi <i class="fas fa-arrow-right ms-1"></i>
                                </a>
                            </div>
                        @endif
                    </div>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card border-0 shadow-sm rounded-3">
                    <div
                        class="card-header py-3 bg-transparent d-flex justify-content-between align-items-center flex-wrap">
                        <h5 class="card-title mb-0 fw-bold">Biểu đồ Doanh thu</h5>

                        <form action="{{ route('admin.dashboard') }}" method="GET"
                            class="d-flex gap-2 align-items-center mt-2 mt-md-0">
                    ...
                    <div class="card mt-4 bg-transparent border-secondary">
                        <div class="card-header border-secondary text-white fw-bold">
                            <i class="fas fa-table me-2"></i> Bảng dữ liệu thống kê chi tiết
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table
                                    class="table table-dark table-hover table-bordered border-secondary mb-0 text-center">
                                    ...
                                    <tbody>
                                        @foreach($orders as $order)
                                            <tr>
                                                <td>#{{ $order->id }}</td>
                                                <td>{{ $order->player->username ?? 'Khách' }}</td>
                                                <td>{{ \Carbon\Carbon::parse($order->created_at)->format('d/m/Y H:i') }}</td>
                                                <td>
                                                    <span class="badge bg-secondary">{{ strtoupper($order->order_type) }}</span>
                                                </td>
        ...
        <div class="col-12 col-lg-8">
            <div class="card border-0 shadow-sm mb-4 rounded-3 h-100">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-4 text-muted">Chưa có đơn hàng nào trong hệ
                                            thống.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                ...
                <div class="card-footer border-0 py-3 text-center">
                    <a href="{{ route('admin.orders.index') }}" class="text-decoration-none small fw-bold">Xem tất cả <i
